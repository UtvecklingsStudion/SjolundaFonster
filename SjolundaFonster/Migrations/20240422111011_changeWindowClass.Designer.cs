...
namespace SjolundaFonster.Migrations
{
    ...
    [Migration("20240422111011_changeWindowClass")]
    partial class changeWindowClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SjolundaFonster.Data.Models.Window", b =>
                {
                    b.HasOne("SjolundaFonster.Data.Models.Color", null)
                        .WithMany("Products")
                        .HasForeignKey("ColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SjolundaFonster.Data.Models.Model", null)
                        .WithMany("Products")
